...
/* ==========================================================================
   FLAG ICON SOURCES — working SVGs
   ========================================================================== */
...
/* ==========================================================================
   MARKER ICON SOURCES — EXACT from original version
   ========================================================================== */
...
/* ==========================================================================
   WAYPOINT IMAGE SOURCES — EXACT as original v1
   ========================================================================== */
...
const IMG_UTICA      = "https://raw.githubusercontent.com/BSMediaGroup/Resources/master/IMG/ultica.webp";
...
/* ==========================================================================
   WAYPOINTS — FULL RESTORED LIST (ALL 20 WAYPOINTS)
   ========================================================================== */
...
/* ==========================================================================
   TRIP ORDER — EXACT original behaviour (full waypoint sequence)
   ========================================================================== */
const TRIP_ORDER = WAYPOINTS.map(w => w.id);

/* ==========================================================================
   DRIVE ORDER — original logic: everything *after* Toronto
   ========================================================================== */
