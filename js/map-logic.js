/* ============================================================
   MAP UI MODULE — v2 (FULLY REPAIRED)
   ============================================================ */
...
/* ========================================================================== */
/* SECTION 4 — POI HOOKS (NO-OP FOR NOW)                                      */
/* ========================================================================== */

async function fetchMapboxPOI() { return null; }
async function updateSidebarPOISections() { return; }

const _origOpenDetailsSidebar2 = openDetailsSidebar;
openDetailsSidebar = async function (id) {
  _origOpenDetailsSidebar2(id);
  const wp = WAYPOINTS.find(x => x.id === id);
  if (!wp) return;
  await updateSidebarPOISections(wp);
};

window.fetchMapboxPOI = fetchMapboxPOI;
window.updateSidebarPOISections = updateSidebarPOISections;
